...
const expect = require('chai').expect,
    ...
    isReservedTableName = require('../../../../lib/core/jbooter/reserved_keywords').isReservedTableName,
...
describe('ReservedKeywords', function () {
  describe('::isReserved', function () {
    ...
    describe('when passing an invalid jbooter keyword, no matter the case', function() {
