...
const expect = require('chai').expect,
    ...
    RelationshipTypes = require('../../../lib/core/jbooter/relationship_types').RELATIONSHIP_TYPES,
...
describe('::parse', function () {
  ...
  describe('when parsing app config file to JDL', function () {
    it('parses server options', function () {
      var yoRcJson = Reader.readEntityJSON('./test/test_files/jbooter_app/.yo-rc.json');
      var content = Parser.parseServerOptions(yoRcJson['generator-jbooter']);
  ...
  describe('when parsing entities with relationships to User', function () {
    describe('when skipUserManagement flag is not set', function () {
      describe('when there is no User.json entity', function () {
        it('parses relationships to the JBooter managed User entity', function () {
          var entities = {
            Country: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/Country.json')
          };
          var content = Parser.parseEntities(entities);
